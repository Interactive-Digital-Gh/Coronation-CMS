    ...
    <div class="dashboard-main-wrapper">
       ...
       @include('components.navbar')
        ...
        <div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Institute Engineering Insurance Benefits</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Engineering Benefits</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <form action="{{ route('institute-engineering-benefits-update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h2> Engineering Insurance Benefits Body</h2>
                        <div class="card">
                            @php
                                $body = $eng->benefits_body;
                            @endphp
                                        <div class="card-body">
                                            <div class="form-row">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            @php
                                $comp = $eng->comprehensive_benefits;
                                $tpft = $eng->tp_fire_theft_benefits;
                            @endphp

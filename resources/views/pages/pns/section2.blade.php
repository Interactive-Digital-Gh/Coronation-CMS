<x-cms-layout title="Products & Solutions Section 2"
              :breadcrumbs="['Individual' => null, 'Products & Solutions' => route('pns-header'), 'Section 2' => null]"
              preview="https://coronation.com.gh/">
    <x-cms.form :action="route('pns-section2-update')" files>

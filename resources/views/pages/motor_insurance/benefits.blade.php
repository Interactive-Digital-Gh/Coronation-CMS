    ...
    <div class="dashboard-main-wrapper">
       ...
       @include('components.navbar')
        ...
        <div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Motor Insurance Benefits</h2>
            ...
            <form action="{{ route('motor-update-benefits') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            @php
                                $comp = $motor->comprehensive_ins_benefits;
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        <label for="exampleFormControlTextarea1">Comprehensive</label>
                                        <textarea id="shortText" name="comprehensive_benefits">{{ $comp }}</textarea>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        <label for="exampleFormControlTextarea1">Third Party Fire and Theft</label>

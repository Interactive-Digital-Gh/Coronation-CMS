<x-cms-layout title="Motor Insurance Header"
              :breadcrumbs="['Individual' => null, 'Products & Solutions' => route('pns-header'), 'Motor Insurance Header' => null]"
              preview="https://coronation.com.gh/">
    <x-cms.form :action="route('motor-header-update')" files>

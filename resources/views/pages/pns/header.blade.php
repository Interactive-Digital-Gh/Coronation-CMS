<x-cms-layout title="Products & Solutions Header"
              :breadcrumbs="['Individual' => null, 'Products & Solutions' => route('pns-header'), 'Header' => null]"
              preview="https://coronation.com.gh/">
    <x-cms.form :action="route('pns-header-update')" files>

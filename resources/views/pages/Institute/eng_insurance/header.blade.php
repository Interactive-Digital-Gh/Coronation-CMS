...
<head>
    ...
    <title>Institute Enginerring Insurance Header</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="dashboard-main-wrapper">
       ...
       @include('components.navbar')
        ...
        <div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Institute Enginerring Insurance Header </h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Institute</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Enginerring Insurance</a></li>
            ...
            <form action="{{ route('institute-eng-header-update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            @php
                                $caption = $eng->header_caption;
                                $body = $eng->header_body;
                            @endphp

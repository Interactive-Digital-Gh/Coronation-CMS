    ...
    <div class="dashboard-main-wrapper">
       ...
       @include('components.navbar')
        ...
        <div class="dashboard-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Marine Insurance Benefits</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Marine Benefits</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <form action="{{ route('institute-marine-benefits-update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <h3>Marine Benefits Image</h3>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Upload Benefits Image</h5>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            @php
                                $body = $marine->benefits_body;
                                $benefits = $marine->marine_benefits;
                            @endphp

                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        <label for="exampleFormControlTextarea1">Marine Insurance Benefits Body</label>
                                        <textarea id="shortText" name="benefits_body">{{ $body }}</textarea>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                                        <label for="exampleFormControlTextarea1">Marine Insurance Benefits</label>
